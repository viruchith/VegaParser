...
SUITE: list[BenchmarkTarget] = [
    ...
    BenchmarkTarget("c-heavy", "https://github.com/torvalds/linux", "heavy", ("c",), "Massive C codebase"),
    BenchmarkTarget("c-light", "https://github.com/libuv/libuv", "light", ("c",), "Async I/O library"),
    BenchmarkTarget("cpp-heavy", "https://github.com/llvm/llvm-project", "heavy", ("cpp",), "Large C++ project"),
    ...
    BenchmarkTarget("plsql-heavy", "https://github.com/oracle-samples/db-sample-schemas", "heavy", ("plsql",), "Oracle sample schemas"),
    BenchmarkTarget("plsql-light", "https://github.com/utPLSQL/utPLSQL", "light", ("plsql",), "Popular PL/SQL test framework"),
